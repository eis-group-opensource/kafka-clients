...
public class StopReplicaRequestData implements ApiMessage {
    ...
    private List<StopReplicaTopicV1> topics;
    ...
    static public class StopReplicaTopicV1 implements Message {
        private String name;
    ...
    static public class StopReplicaTopicState implements Message {
        private String topicName;
        private List<StopReplicaPartitionState> partitionStates;
        private List<RawTaggedField> _unknownTaggedFields;
    ...
    static public class StopReplicaPartitionState implements Message {
        private int partitionIndex;
