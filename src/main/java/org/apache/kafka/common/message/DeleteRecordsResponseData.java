...
public class DeleteRecordsResponseData implements ApiMessage {
    ...
    static public class DeleteRecordsTopicResult implements Message, ImplicitLinkedHashMultiCollection.Element {
        private String name;
    ...
    static public class DeleteRecordsPartitionResult implements Message, ImplicitLinkedHashMultiCollection.Element {
