...
public interface Time {
     ...
     *
     * @param lock The object that will be waited with {@link Object#wait()}. Note that it is the responsibility
     *      of the caller to call notify on this object when the condition is satisfied.
     * @param until The condition we are awaiting
     * @param timeoutMs How long to wait in milliseconds
     *
     * @throws org.apache.kafka.common.errors.TimeoutException if the timeout expires before the condition is satisfied
     */
    void waitObject(Lock lock, Condition condition, Supplier<Boolean> until, long timeoutMs) throws InterruptedException;
